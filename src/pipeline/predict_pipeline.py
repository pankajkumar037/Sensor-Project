    ...
    def save_input_files(self) -> str:
        try:
            ...
            if not input_csv_file or input_csv_file.filename == "":
                raise ValueError("No file was uploaded or filename is empty.")

            # Only take base name to avoid paths like "C:/user/file.csv"
            ...
            logging.error(f"Exception in save_input_files: {e}")
